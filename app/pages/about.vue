                    ...
                    <div class="flex flex-wrap">
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          <a href="mailto:adhocassembly@gmail.com" class="underline"
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          <NuxtLink to="/submit" class="underline">
                            Submit a Work form
                          </NuxtLink>
...
<script setup>
useSeoMeta({
  title: 'About - Abundance of Works',
  description: 'Learn about the Abundance of Works database and its mission to document theatrical works'
})
</script>
