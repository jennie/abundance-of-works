<template>
  <Layout>
    <div class="container-inner mx-auto py-16">
      ...
      <pagination-posts
        class="py-8"
        v-if="$page.allPublisher.pageInfo.totalPages > 1"
        base="/publishers"
        :totalPages="$page.allPublisher.pageInfo.totalPages"
        :currentPage="$page.allPublisher.pageInfo.currentPage"
      />
      <div class="divide-y divide-darkLinen">
        <div v-for="producer in $page.allPublisher.edges" :key="producer.id">
          <g-link
...
query ($page: Int) {
  ...
  allPublisher(sortBy: "Created", order: DESC, perPage: 20, page: $page) @paginate {
    totalCount
    pageInfo {
      totalPages
      currentPage
